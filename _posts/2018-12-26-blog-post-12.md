...
<figure>
<img alt="three birds on a branch" src="/images/blog/pk_profile.png" style="width:75%">
<figcaption>Two concentration profiles under different dosing regimes.  The red curve exceeds the "Goldilocks" zone. Is that departure still therapeutic?  If not, what is a better

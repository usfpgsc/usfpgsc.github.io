...
OK, that is a but of hyperbole.  Emma, a connection of mine on LinkedIn, has been participating in [Advent of Code](https://adventofcode.com/).  She commented that she would like to see how I would approach some of these problems, so I figured I would start doing some myself.
...
def check_condition_part2(x):
    ...
    #Find any sequences of numbers which are the same
    ix = x[:-1]==x[1:]
...
I actually got this question wrong because I didn't read that I was not supposed to include my answer from part 1.  So the real answer is $2495-1251 = 1244$.
